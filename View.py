...
class View():
    ...
    def logUpdate(self, idSensor):
        self.lblmsg["text"] = "Sensor {} foi adicionado!".format(idSensor)
    
    def deleteSensor(self, idSensor):
        self.lblmsg["text"] = "Sensor {} foi excluido!".format(idSensor)
        
    def atualizarSensor(self, idSensor):
        self.lblmsg["text"] = "Sensor {} foi alterado!".format(idSensor)
